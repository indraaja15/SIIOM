                    ...
                    @foreach ($data_barang as $key => $value)
                        @if (auth()->user()->ormawa_id == $value->ormawa_id)
                            <tr>
                                ...
                                @endif
                                <td class="text-center">{{ $value->detail_barang->count() }}</td>
                                ...
                                <td>
                                    <center><a style="width:100px" class="btn btn-info fas fa-edit mb-2"
                                            ...
                                            <center><a style="width:100px" class="btn btn-info fas fa-eye mb-2"
                                                href="{{ url('detail/' . $value->id)}}"> Detail</a></center>
                ...
                <div class="modal-content">
                    <form action="{{ url('barang') }}" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <input type="number" name="qty" class="form-control" placeholder="Qty Yang Dapat Dipinjam" id="qty"
                                required><br>
                            <div class="mb-3">
                                <input class="form-control @error('foto') is-invalid @enderror" name="foto"
                                    type="file" id="formFile" placeholder="Foto Barang" required>
                                    <small class="text-danger">*Max Size File 1Mb</small>
                            </div>
